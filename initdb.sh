...
db2 "CREATE BUFFERPOOL USERBP1 IMMEDIATE  SIZE 1000 AUTOMATIC PAGESIZE 80 K"
db2 "CREATE  LARGE  TABLESPACE USERSPACE1 PAGESIZE 80 K  MANAGED BY AUTOMATIC STORAGE EXTENTSIZE 16 OVERHEAD 10.5 PREFETCHSIZE 16 TRANSFERRATE 0.14 BUFFERPOOL USERBP1"
db2 "CREATE BUFFERPOOL SUGARBP IMMEDIATE  SIZE 1000 AUTOMATIC PAGESIZE 80 K"
db2 "CREATE  LARGE  TABLESPACE SUGARTS PAGESIZE 80K  MANAGED BY AUTOMATIC STORAGE EXTENTSIZE 16 OVERHEAD 10.5 PREFETCHSIZE 16 TRANSFERRATE 0.14 BUFFERPOOL SUGARBP"

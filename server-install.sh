...
sudo ./atoi-sc install --pack-install "http://sc2.gnuhub.com/sugarsync/ibm_production/SugarUltimate-production-135-08102015.zip http://sc2.gnuhub.com/sugarsync/ibm_r31/SugarUltimate-r31-12-base-production-135-08112015.zip" --debug --install-name 50 --dbname DB_50
